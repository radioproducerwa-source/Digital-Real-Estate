...
"""
    ...
    "url": "https://perthmechanic.com.au/{slug}.html",
...
{nearby_pills}
    ...
    <div id="quote">
      ...
      <div style="background:var(--blue-lt);border:1.5px solid var(--border);border-radius:var(--radius);padding:20px;margin-top:20px;text-align:center;">
        ...
        <a href="mailto:info@perthmechanic.com.au" style="font-size:1rem;font-weight:700;color:var(--blue);">info@perthmechanic.com.au</a>
